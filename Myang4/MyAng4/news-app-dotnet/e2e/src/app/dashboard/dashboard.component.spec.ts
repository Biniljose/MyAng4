...
describe('DashboardComponent', () => {
  ...
  it('should use ConfigService to get news headlines', () => {
    config = TestBed.get(ConfigService);
    expect(config.getHeadlines()).toBeDefined();
  });

  it('should use ConfigService to get Category headlines', () => {
    config = TestBed.get(ConfigService);
    expect(config.getCategories('general')).toBeDefined();
  });
});
